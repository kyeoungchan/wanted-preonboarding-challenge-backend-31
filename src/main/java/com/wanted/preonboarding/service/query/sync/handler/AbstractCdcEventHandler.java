...
public abstract class AbstractCdcEventHandler implements CdcEventHandler {
    ...
    protected Long getLongValue(Map<String, Object> data, String key) {
        ...
        if (value instanceof Number) {
            ...
            try {
                ...
                log.warn("Error parsing Long value for key '{}': {}", key, value, e);
                return null;
            }
        }
        return null;
    ...
    protected Integer getIntegerValue(Map<String, Object> data, String key) {
        ...
        if (value instanceof Number) {
            ...
            try {
                ...
                log.warn("Error parsing Integer value for key '{}': {}", key, value, e);
                return null;
            }
        }
        return null;
    ...
    protected Double getDoubleValue(Map<String, Object> data, String key) {
        ...
        if (value instanceof Number) {
            ...
            try {
                ...
                log.warn("Error parsing Double value for key '{}': {}", key, value, e);
                return null;
            }
        }
        return null;
    ...
    protected BigDecimal getBigDecimalValue(Map<String, Object> data, String key) {
        ...
        if (value instanceof String) {
            ...
            try {
                ...
                log.warn("Error parsing BigDecimal value for key '{}': {}", key, value, e);
                return null;
            }
    ...
    private BigDecimal decodeDecimalFromBase64(String base64Value, int scale) {
        ...
        try {
            ...
            log.error("Failed to decode Base64 string '{}' for decimal value: {}", base64Value, e);
            return null;
        } catch (Exception e) {
